...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  #    post data_url, params: { datum: { data: @datum.data, key: @datum.key, time: @datum.time, user_id: @datum.user_id } }
  #  end
  ...
  #  patch datum_url(@datum), params: { datum: { data: @datum.data, key: @datum.key, time: @datum.time, user_id: @datum.user_id } }
