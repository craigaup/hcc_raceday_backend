...
class DistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distance" do
    assert_difference('Distance.count') do
      post distances_url, params: { distance: { checkpoint: @distance.checkpoint, distance: @distance.distance, year: @distance.year } }
    end
  ...
  test "should update distance" do
    patch distance_url(@distance), params: { distance: { checkpoint: @distance.checkpoint, distance: @distance.distance, year: @distance.year } }
